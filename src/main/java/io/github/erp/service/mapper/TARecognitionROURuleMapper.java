...
/**
 * Mapper for the entity {@link TARecognitionROURule} and its DTO {@link TARecognitionROURuleDTO}.
 */
...
public interface TARecognitionROURuleMapper extends EntityMapper<TARecognitionROURuleDTO, TARecognitionROURule> {
    ...
    TARecognitionROURuleDTO toDto(TARecognitionROURule s);

    @Mapping(target = "removePlaceholder", ignore = true)
    TARecognitionROURule toEntity(TARecognitionROURuleDTO tARecognitionROURuleDTO);
}
