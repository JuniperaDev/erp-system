...
/**
 * Mapper for the entity {@link TALeaseRecognitionRule} and its DTO {@link TALeaseRecognitionRuleDTO}.
 */
...
public interface TALeaseRecognitionRuleMapper extends EntityMapper<TALeaseRecognitionRuleDTO, TALeaseRecognitionRule> {
    ...
    TALeaseRecognitionRuleDTO toDto(TALeaseRecognitionRule s);

    @Mapping(target = "removePlaceholder", ignore = true)
    TALeaseRecognitionRule toEntity(TALeaseRecognitionRuleDTO tALeaseRecognitionRuleDTO);
}
