...
@Repository
public interface LeaseRepaymentTransactionDetailsRepository
    ...
    @Query(
        ...
        value = "" +
            ...
            "    lc.short_title || ' ' || REPLACE(fm.fiscal_month_code, 'YM', '') || 'REPAYMENT' AS description, " +
            "    lls.cash_payment AS amount, " +
