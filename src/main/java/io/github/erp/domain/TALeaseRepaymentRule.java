...
/**
 * A TALeaseRepaymentRule.
 */
@Entity
@Table(name = "talease_repayment_rule")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@org.springframework.data.elasticsearch.annotations.Document(indexName = "taleaserepaymentrule")
public class TALeaseRepaymentRule implements Serializable {
    ...
    @ManyToMany
    @JoinTable(
        name = "rel_talease_repayment_rule__placeholder",
        joinColumns = @JoinColumn(name = "talease_repayment_rule_id"),
    ...
    public TALeaseRepaymentRule id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public TALeaseRepaymentRule name(String name) {
        this.setName(name);
        return this;
    }
    ...
    public TALeaseRepaymentRule identifier(UUID identifier) {
    ...
    public TALeaseRepaymentRule debit(TransactionAccount transactionAccount) {
    ...
    public TALeaseRepaymentRule credit(TransactionAccount transactionAccount) {
    ...
    public TALeaseRepaymentRule placeholders(Set<Placeholder> placeholders) {
        this.setPlaceholders(placeholders);
        return this;
    }

    public TALeaseRepaymentRule addPlaceholder(Placeholder placeholder) {
        this.placeholders.add(placeholder);
        return this;
    }

    public TALeaseRepaymentRule removePlaceholder(Placeholder placeholder) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TALeaseRepaymentRule)) {
            return false;
        }
        return id != null && id.equals(((TALeaseRepaymentRule) o).id);
    }
