...
/**
 * A DTO for the {@link io.github.erp.domain.TALeaseRepaymentRule} entity.
 */
public class TALeaseRepaymentRuleDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TALeaseRepaymentRuleDTO)) {
            return false;
        }

        TALeaseRepaymentRuleDTO tALeaseRepaymentRuleDTO = (TALeaseRepaymentRuleDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, tALeaseRepaymentRuleDTO.id);
    }
    ...
    public String toString() {
        return "TALeaseRepaymentRuleDTO{" +
            "id=" + getId() +
            ", name='" + getName() + "'" +
