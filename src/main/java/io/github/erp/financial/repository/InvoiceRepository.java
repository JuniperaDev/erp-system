...
public interface InvoiceRepository extends JpaRepository<Invoice, Long>, JpaSpecificationExecutor<Invoice> {
    ...
    @Query(
        value = "select distinct invoice from Invoice invoice left join fetch invoice.settlementCurrency left join fetch invoice.biller",
    ...
    @Query("select distinct invoice from Invoice invoice left join fetch invoice.settlementCurrency left join fetch invoice.biller")
    List<Invoice> findAllWithToOneRelationships();

    @Query("select invoice from Invoice invoice left join fetch invoice.settlementCurrency left join fetch invoice.biller where invoice.id =:id")
