...
/**
 * A DTO for the {@link io.github.erp.domain.TARecognitionROURule} entity.
 */
public class TARecognitionROURuleDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TARecognitionROURuleDTO)) {
            return false;
        }

        TARecognitionROURuleDTO tARecognitionROURuleDTO = (TARecognitionROURuleDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, tARecognitionROURuleDTO.id);
    }
    ...
    public String toString() {
        return "TARecognitionROURuleDTO{" +
            "id=" + getId() +
            ", name='" + getName() + "'" +
