...
public class AssetCategoryResourceProd {

    private final Logger log = LoggerFactory.getLogger(AssetCategoryResourceProd.class);
    ...
    public AssetCategoryResourceProd(
