...
/**
 * Integration tests for the {@link AssetAccessoryResource} REST controller.
 */
@IntegrationTest
...
class AssetAccessoryResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/asset-accessories";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/asset-accessories";
