...
@Service
@Transactional
public class LeaseAmortizationScheduleServiceImpl implements LeaseAmortizationScheduleService {

    private final Logger log = LoggerFactory.getLogger(LeaseAmortizationScheduleServiceImpl.class);
