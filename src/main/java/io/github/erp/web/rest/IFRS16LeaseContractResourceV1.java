...
@RequestMapping("/api")
@Transactional
public class IFRS16LeaseContractResourceV1 {

    private final Logger log = LoggerFactory.getLogger(IFRS16LeaseContractResourceV1.class);
    ...
    public IFRS16LeaseContractResourceV1(
