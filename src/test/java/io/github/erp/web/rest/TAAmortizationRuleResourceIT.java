...
/**
 * Integration tests for the {@link TAAmortizationRuleResource} REST controller.
 */
@IntegrationTest
...
class TAAmortizationRuleResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/ta-amortization-rules";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/ta-amortization-rules";
