...
/**
 * Integration tests for the {@link RouInitialDirectCostResource} REST controller.
 */
@IntegrationTest
...
class RouInitialDirectCostResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/rou-initial-direct-costs";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/rou-initial-direct-costs";
