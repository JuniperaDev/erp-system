...
/**
 * Criteria class for the {@link io.github.erp.domain.DealerGroup} entity. This class is used
 * in {@link io.github.erp.web.rest.DealerGroupResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /dealer-groups?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class DealerGroupCriteria implements Serializable, Criteria {
    ...
    public DealerGroupCriteria() {}

    public DealerGroupCriteria(DealerGroupCriteria other) {
    ...
    @Override
    public DealerGroupCriteria copy() {
        return new DealerGroupCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final DealerGroupCriteria that = (DealerGroupCriteria) o;
        return (
