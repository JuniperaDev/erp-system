...
@Service
@Transactional
public class TALeaseRecognitionRuleServiceImpl implements TALeaseRecognitionRuleService {

    private final Logger log = LoggerFactory.getLogger(TALeaseRecognitionRuleServiceImpl.class);
