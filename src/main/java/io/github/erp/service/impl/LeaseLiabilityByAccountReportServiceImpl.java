...
@Service
@Transactional
public class LeaseLiabilityByAccountReportServiceImpl implements LeaseLiabilityByAccountReportService {

    private final Logger log = LoggerFactory.getLogger(LeaseLiabilityByAccountReportServiceImpl.class);
