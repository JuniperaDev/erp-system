...
/**
 * Integration tests for the AssetRevaluationResourceProd REST controller.
 */
@IntegrationTest
...
class AssetRevaluationResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/fixed-asset/asset-revaluations";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/fixed-asset/_search/asset-revaluations";
