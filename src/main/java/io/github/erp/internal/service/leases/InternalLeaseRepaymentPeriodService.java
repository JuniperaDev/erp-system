 ...
 */
public interface InternalLeaseRepaymentPeriodService {
    /**
     ...
     * @return the list of entities.
     */
    Optional<List<LeaseRepaymentPeriodDTO>> findLeasePeriods(LocalDate commencementDate, int numberOfPeriods);
}
