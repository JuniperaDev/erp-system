...
/**
 * Integration tests for the NetBookValueEntryResource REST controller.
 */
@IntegrationTest
...
class NetBookValueEntryResourceIT {
    ...
    private static final String ENTITY_SEARCH_API_URL = "/api/fixed-asset/_search/net-book-value-entries";
