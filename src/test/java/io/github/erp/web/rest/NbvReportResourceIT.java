...
/**
 * Integration tests for the {@link NbvReportResource} REST controller.
 */
@IntegrationTest
...
class NbvReportResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/nbv-reports";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/nbv-reports";
