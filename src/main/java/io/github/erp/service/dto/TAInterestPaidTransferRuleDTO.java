...
/**
 * A DTO for the {@link io.github.erp.domain.TAInterestPaidTransferRule} entity.
 */
public class TAInterestPaidTransferRuleDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TAInterestPaidTransferRuleDTO)) {
            return false;
        }

        TAInterestPaidTransferRuleDTO tAInterestPaidTransferRuleDTO = (TAInterestPaidTransferRuleDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, tAInterestPaidTransferRuleDTO.id);
    }
    ...
    public String toString() {
        return "TAInterestPaidTransferRuleDTO{" +
            "id=" + getId() +
            ", name='" + getName() + "'" +
