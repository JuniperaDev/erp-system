...
/**
 * A DTO for the {@link io.github.erp.domain.TALeaseInterestAccrualRule} entity.
 */
public class TALeaseInterestAccrualRuleDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TALeaseInterestAccrualRuleDTO)) {
            return false;
        }

        TALeaseInterestAccrualRuleDTO tALeaseInterestAccrualRuleDTO = (TALeaseInterestAccrualRuleDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, tALeaseInterestAccrualRuleDTO.id);
    }
    ...
    public String toString() {
        return "TALeaseInterestAccrualRuleDTO{" +
            "id=" + getId() +
            ", name='" + getName() + "'" +
