...
import io.github.erp.internal.repository.InternalTransactionAccountRepository;
...
@Service
@Transactional
public class InternalTransactionAccountServiceImpl implements InternalTransactionAccountService {

    private final Logger log = LoggerFactory.getLogger(InternalTransactionAccountServiceImpl.class);

    private final InternalTransactionAccountRepository transactionAccountRepository;
    ...
    public InternalTransactionAccountServiceImpl(
        InternalTransactionAccountRepository transactionAccountRepository,
