...
@Service
@Transactional
public class LeaseLiabilityReportItemServiceImpl implements LeaseLiabilityReportItemService {

    private final Logger log = LoggerFactory.getLogger(LeaseLiabilityReportItemServiceImpl.class);
