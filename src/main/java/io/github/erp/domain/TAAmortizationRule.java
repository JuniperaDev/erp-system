...
public class TAAmortizationRule implements Serializable {
    ...
    @ManyToMany
    @JoinTable(
        name = "rel_taamortization_rule__placeholder",
        joinColumns = @JoinColumn(name = "taamortization_rule_id"),
    ...
    public TAAmortizationRule id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public TAAmortizationRule name(String name) {
        this.setName(name);
        return this;
    }
    ...
    public TAAmortizationRule identifier(UUID identifier) {
    ...
    public TAAmortizationRule debit(TransactionAccount transactionAccount) {
    ...
    public TAAmortizationRule credit(TransactionAccount transactionAccount) {
    ...
    public TAAmortizationRule placeholders(Set<Placeholder> placeholders) {
        this.setPlaceholders(placeholders);
        return this;
    }

    public TAAmortizationRule addPlaceholder(Placeholder placeholder) {
        this.placeholders.add(placeholder);
        return this;
    }

    public TAAmortizationRule removePlaceholder(Placeholder placeholder) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TAAmortizationRule)) {
            return false;
        }
        return id != null && id.equals(((TAAmortizationRule) o).id);
    }
