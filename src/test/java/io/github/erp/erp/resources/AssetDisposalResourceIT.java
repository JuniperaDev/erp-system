...
/**
 * Integration tests for the AssetDisposalResource REST controller.
 */
@IntegrationTest
...
class AssetDisposalResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/fixed-asset/asset-disposals";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/fixed-asset/_search/asset-disposals";
