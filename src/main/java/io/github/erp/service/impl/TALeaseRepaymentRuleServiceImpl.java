...
@Service
@Transactional
public class TALeaseRepaymentRuleServiceImpl implements TALeaseRepaymentRuleService {

    private final Logger log = LoggerFactory.getLogger(TALeaseRepaymentRuleServiceImpl.class);
