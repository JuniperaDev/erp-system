...
/**
 * A DTO for the {@link io.github.erp.domain.TAAmortizationRule} entity.
 */
public class TAAmortizationRuleDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TAAmortizationRuleDTO)) {
            return false;
        }

        TAAmortizationRuleDTO tAAmortizationRuleDTO = (TAAmortizationRuleDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, tAAmortizationRuleDTO.id);
    }
