package io.github.erp.context.assets.repository;
...
public interface AssetRegistrationRepository extends JpaRepository<AssetRegistration, Long>, JpaSpecificationExecutor<AssetRegistration> {
    @Query(
        value = "select distinct assetRegistration from AssetRegistration assetRegistration left join fetch assetRegistration.placeholders",
    ...
    @Query("select distinct assetRegistration from AssetRegistration assetRegistration left join fetch assetRegistration.placeholders")
