...
/**
 * Integration tests for the AssetGeneralAdjustmentResource REST controller.
 */
@IntegrationTest
...
class AssetGeneralAdjustmentResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/fixed-asset/asset-general-adjustments";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/fixed-asset/_search/asset-general-adjustments";
